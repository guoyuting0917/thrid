...
module md_global
  ...
  character(3),parameter:: pgkiniver = "5.8" ! peachgk.ini Version num.
  character(8),parameter:: pgkinidate = "18.10.03" ! peachgk.ini rev. date
  !---- maximum number of arrays
  ! - declare variables for constant parameter
  integer,parameter:: maxnstage = 10 ! maximum number of MD stage
  integer,parameter:: maxnproc = 1000
                                       ! maximum number of processes for MPI run
  integer,parameter:: maxninttyp = 20 ! maximum interaction type
  integer,parameter:: maxnatom = 30000 ! maximum number of atoms
  integer,parameter:: maxnmol = 300 ! maximum number in each molecule
  integer,parameter:: maxnbond = 50000
  integer,parameter:: maxnangl = 50000
  integer,parameter:: maxntors = 50000
  integer,parameter:: maxnconst = 50000
  integer,parameter:: maxnlist = 1500
                                ! maximum number of atom per one atom in nblist
  integer,parameter:: maxmorlist = 1500
                                ! maximum number of atom per one atom in morlist
  integer,parameter:: maxshlist = 500
                                ! maximum number of atom per one atom in SHlist
  integer,parameter:: maxrfhlist = 500
                                ! maximum number of atom per one atom in RFHlist
  integer,parameter:: maxdoulist = 500
                                ! maximum number of atom per one atom in DOUlist
  integer,parameter:: maxrpvwlist = 1500
                                ! maximum number of atom per one atom in RP-VWlist
  integer,parameter:: maxcstmnblist = 500
                                ! maximum number of atom per one atom in cstmnblist
  integer,parameter:: maxnvdwtyp = 500
                                ! maximum number of types of vdW interaction
  integer,parameter:: maxnatmtyp = 500
                                ! maximum number of atom types
  integer,parameter:: maxnbondtyp = 200
  integer,parameter:: maxnangltyp = 200
  integer,parameter:: maxntorstyp = 100
  integer,parameter:: maxnmortyp = 100
  integer,parameter:: maxnshtyp = 5
  integer,parameter:: maxnrfhtyp = 15
  integer,parameter:: maxndoutyp = 10
  integer,parameter:: maxnrpvwtyp = 10
  integer,parameter:: maxncstmnbtyp = 100
  integer,parameter:: maxnconsttyp = 100
                                ! maximum number of constraint pair type
  integer,parameter:: maxnpolytyp = 20
                                ! maximum number of polymer type species
  integer,parameter:: maxnmatyp = 20
                                ! maximum number of monatomic type species
  integer,parameter:: maxwave = 4631 ! =(kmax*2+1)**3/2
  integer,parameter:: maxnhc = 10 ! max num. of Nose-Hoover chain
  integer,parameter:: maxnyosh = 5 ! max num. of Yoshida-Suzuki method
  integer,parameter:: max_cellx = 10
                                        ! maximum number of cell-index cell (x)
  integer,parameter:: max_celly = 10
                                        ! maximum number of cell-index cell (y)
  integer,parameter:: max_cellz = 25
                                        ! maximum number of cell-index cell (z)
  integer,parameter:: max_cellindex = 10 + 10*10 &
       & + 10*10*25
                                        ! maximum number of cell-index cell all
  integer,parameter:: max_atomcell = 1000
                                        ! maximum number of atoms for each cell
  integer,parameter:: max_interpol = 10000
                                 ! maximum number of spline interpolation points
  integer,parameter:: max_spl_order = 3
                                 ! maximum order of spline function
  integer,parameter:: maxntcregion = 20
                                   ! maximum number of region for temp. control
  integer,parameter:: maxnword = 20
                                       ! maximum number of words from data file
  integer,parameter:: maxnhfregion = 30
                                 ! maximum number of region for heat flux calc.
  integer,parameter:: maxnintpbias = 500
                                      ! maximum number of sampling according to
                                      ! reaction coordinate with bias potential
  integer,parameter:: maxnvelregion = 500
