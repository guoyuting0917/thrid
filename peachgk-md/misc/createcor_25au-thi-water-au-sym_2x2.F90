!*************************************************
!*  createcor.f Ver.2.5cu-thi-water-cu '12.08.08 *
!*      for peachgk_md.f                         *
!*            by G.Kikugawa                      *
!**************************************************
...
!     parameters for fcc lattice
  ...
  real(8):: base_latt(2,8)
  real(8):: shift_latt(2,0:2)

  real(8):: base_latt_S1(2,2)
  real(8):: base_latt_S2(2,2)
...
!---- notation ----
  ...
  water_layer = 60.0d-10 / xref
  thiol_layer = 12.93d-10 / xref
...
!---- create base lattice for thiol S (2 layer over 1 layer)
  ...
  base_latt_S1(2,1) = (1.0d0+0.0d0      ) * A1

  base_latt_S1(1,2) = 0.5d0 * A0
  base_latt_S1(2,2) = (3.0d0+0.0d0      ) * A1

!---- create base lattice for thiol S (0 layer over 1 layer)
  base_latt_S2(1,1) = 1.0d0 * A0
  base_latt_S2(2,1) = (0.0d0+2.0d0/3.0d0) * A1

  base_latt_S2(1,2) = 0.0d0 * A0
  base_latt_S2(2,2) = (2.0d0+2.0d0/3.0d0) * A1
