!******************************
!*  calanglub_hf.f90 Ver.1.1  *
!*      for peachgk_md.f      *
!*            by G.Kikugawa   *
!******************************
! Time-stamp: <2014-07-01 15:42:30 gota>
...
! LOCAL:
  ...
  real(8):: fik(3)                      ! temporal storage for
                                        !  bonding force(i,k)
  real(8):: fki(3)                      ! temporal storage for
                                        !  bonding force(i,k) = -fik
...
!    - calculate bond potential -
     delta_pot = para_cbondub(indexanglubtyp(n)) &
...
!    - for heat flux calculation
     ...
     call calvirihf(iatom,katom,fik,fki,   &
          &         nbodycoeff,   &
          &         box,box_inv,   &
          &         ifhfvol,   &
          &         nhfregion,hfzpos1,hfzpos2,   &
