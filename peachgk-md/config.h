...
#define _MAXNATOM_ 30000
#define _MAXNMOL_  300
#define _MAXNBOND_ 50000
#define _MAXNANGL_ 50000
#define _MAXNTORS_ 50000
#define _MAXNCONST_ 50000
...
#define _MAXCELLX_ 10               // max num. of cell-index cell (x)
#define _MAXCELLY_ 10               // max num. of cell-index cell (y)
...
#define _MAXFFT1_ 100
#define _MAXFFT2_ 100
#define _MAXFFT3_ 240
#define _MAX_GRID_ 240               // this macro should be max(MAXFFT1,2,3)
