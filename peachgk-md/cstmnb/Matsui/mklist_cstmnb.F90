...
!*            by G.Kikugawa  *
!*****************************
! Time-stamp: <2015-01-22 01:13:44 gota>
...
!---- Generate NB list for Matsui interaction
  ...
  IF ((mod(current_step,nstep_bookMATSUI) == 0) .or. &
       & (nstep_bookMATSUI == 1)) THEN

     sqcut = rcut_bookMATSUI * rcut_bookMATSUI
...
!       - cell count
        cellcount(1:3) = INT(box(1:3) / rcut_bookMATSUI)
