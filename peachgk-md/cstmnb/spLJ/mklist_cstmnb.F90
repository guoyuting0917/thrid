...
!*            by G.Kikugawa    *
!*******************************
! Time-stamp: <2015-01-22 00:57:46 gota>
...
!---- Generate NB list for spLJ interaction

  IF ((mod(current_step,nstep_bookspLJ) == 0) .or. &
       & (nstep_bookspLJ == 1)) THEN

     sqcut = rcut_bookspLJ * rcut_bookspLJ
...
!       - cell count
        cellcount(1:3) = INT(box(1:3) / rcut_bookspLJ)
